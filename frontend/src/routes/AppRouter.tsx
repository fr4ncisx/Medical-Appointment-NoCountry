...
import { HistorialCitasPaciente } from "@components/sections/Paciente/HistorialCitas/HistorialCitas";
            ...
            <Routes>
                <Route element={<Layout />}>
                    ...
                    <Route element={<ProtectedRoute requiredRole={UserRole.PACIENTE} />}>
                        ...
                        <Route path="/paciente/historial-citas" element={<HistorialCitasPaciente />} />
